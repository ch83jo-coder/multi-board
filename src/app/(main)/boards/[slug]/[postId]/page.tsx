    ...
    <div className="space-y-5">
      ...
      <Card className="overflow-hidden">
        <header className="border-b border-border-subtle p-5 md:p-7">
          ...
          <div className="mt-5 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Avatar username={post.author?.username ?? "Member"} />
              <div>
                <p className="font-medium">
                  {post.author?.username ?? "Member"}
                </p>
                <p className="text-body-sm text-text-muted">Community member</p>
              </div>
            </div>
            {canEdit && (
        ...
        <div className="flex gap-5 p-5 md:p-7">
          ...
          <article className="min-w-0 flex-1 whitespace-pre-wrap text-body-lg leading-7 text-on-surface-variant">
            {post.content}
          </article>
        </div>
      </Card>
      <Card className="p-5 md:p-7">
        <div className="mb-5 flex items-center justify-between">
          <h2 className="font-headline-md text-headline-md">
            Comments <span className="text-primary">{post.comment_count}</span>
          </h2>
        </div>
