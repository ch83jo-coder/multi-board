...
function buildPrompt(board, recentTitles, count) {
  ...
  return [
    ...
    "話題は上の掲示板名と説明が示すテーマの範囲内から選び、説明にない分野へ広げないでください。",
    "この掲示板の読者が知りたいこと、判断に役立つことを優先してください。",
    "検索対象は特定のブランドや企業の公式サイトに限定せず、一般的な検索エンジンのようにWeb全体から探してください。",
    "掲示板のテーマに応じて、政府・自治体、業界団体、関連企業、信頼できる報道機関や専門メディアなど異なる運営元を使い分け、単一の運営元に偏らないでください。",
    "重要な事実は可能な限り複数の独立した情報源で照合し、公式発表が最適な根拠である場合だけ公式サイトを優先してください。",
    "異なる話題を選び、宣伝調・ニュース記事調ではなく、自然な情報共有や感想、問いかけとして書いてください。",
    "AIがこの掲示板の当事者を装った体験談、実測値、費用、トラブル事例を作らないでください。実体験が必要な話題は、読者に情報提供を呼びかける形にしてください。",
